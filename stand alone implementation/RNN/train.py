...
# Available parameters for type of function train(type, file_name)
# rnn: A basic recurrent neural network
# lstm: A Long Short-Term Memory Network
# fc: A network with a single hidden layer
train(type = "rnn", file_name = "rnn")
train(type = "lstm", file_name = "lstm")
train(type = "fc", file_name = "fc")