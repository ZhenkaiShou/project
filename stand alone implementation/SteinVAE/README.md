...
### Training Loss of a VAE (upper) and an SteinVAE (lower) with 16D Latent Representation:
SteinVAE has higher KL divergence but lower reconstruction loss. 
<p float="center">
  <img src="/stand%20alone%20implementation/SteinVAE/Figures/Average%20Loss/vae_16.png" alt="VAE" width="75%"/>
  <img src="/stand%20alone%20implementation/SteinVAE/Figures/Average%20Loss/steinvae_16.png" alt="SteinVAE" width="75%"/>
</p>
